...
launcher = 'pytorch'
load_from = '/root/AICITY2024_Track4/checkpoint/best_vis_fish_pseudo.pth'
load_pipeline = [
...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='../../dataset/json_labels/datafake.json',
        backend_args=None,
        data_prefix=dict(img='/root/AICITY2024_Track4/dataset/data_fake'),
        data_root='',
        metainfo=dict(classes=(
            'Bus',
            'Bike',
...
test_evaluator = dict(
    ...
    outfile_prefix='./work_dirs/infer_server',
    type='CocoMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
work_dir = './work_dirs/infer_pseudo'
